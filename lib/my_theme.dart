...
class MyTheme {
  ...
  static Color Grey_third = Color.fromRGBO(7, 49, 107, 1);
  static Color login_button = Color.fromRGBO(255, 92, 23, 1);
  ...
  static Color iconcircle = Color(0xffFD5D1A);
  // static Color icon = Color(0xff); // if not sure , use the same color as accent color
