  ...
  onPressDelete(id) {
    showDialog(
        ...
        builder: (_) => AlertDialog(
              contentPadding:
                  EdgeInsets.only(top: 7.0, left: 2.0, right: 2.0, bottom: 2.0),
              content: Padding(
                padding:
          ...
          return StatefulBuilder(builder: (BuildContext context,
            ...
            return AlertDialog(
              ...
              contentPadding: EdgeInsets.only(
                  top: 6.0, left: 36.0, right: 36.0, bottom: 2.0),
              content: Container(
                width: 500,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('May be used to assist delevery',
                            style: TextStyle(
                                fontSize: 13,
      ...
      title: Column(
        children: [
          Text(
            ...
            style: TextStyle(fontSize: 17, color: MyTheme.accent_color),
          ),
          Text(
                    ...
                    child: InkWell(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(
                            top: 7.0, left: 7.0, right: 7.0, bottom: 12.0),
                        child: Icon(
                          Icons.edit,
                          color: MyTheme.dark_grey,
                          size: 7,
            ...
            app_language_rtl.$
                ? Positioned(
                    ...
                    child: InkWell(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(
                            top: 12.0, left: 7.0, right: 7.0, bottom: 7.0),
                        child: Icon(
